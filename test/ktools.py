...
from vsc.config.base import VSC_DATA, GENT, VSC
from vsc.filesystem.quota.entities import QuotaUser, QuotaFileset
from vsc.filesystem.quota.ktools import UsageInformation, UsageType, process_user_quota
from vsc.filesystem.quota.ktools import DjangoPusher, determine_grace_period
...
class TestProcessing(TestCase):
    ...
    def test_process_user_quota(self, mock_django_pusher):
        ...
        quota = [
            ...
            ('2540075', 'gvo00002', UsageInformation(
                used=210,
                soft=240,
                hard=250,
                doubt=1,
    ...
    def test_django_pusher(self):
        ...
        with DjangoPusher("my_storage", client, UsageType.UserUsage, False) as pusher:
